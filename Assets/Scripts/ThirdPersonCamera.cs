...
namespace ThirdPersonTemplate
{
    ...
    public class ThirdPersonCamera : MonoBehaviour
    {
        ...
        {
            float deltaHorizontalRotation = _inputSource.HorizontalInput * _rotationSpeed * Time.deltaTime;
            float deltaVerticalRotation = _inputSource.VerticalInput * _rotationSpeed * Time.deltaTime;
